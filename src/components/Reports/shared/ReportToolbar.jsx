  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div className="flex flex-wrap items-end gap-3">
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900 mb-0.5 sm:mb-2"
        >
          <ArrowLeft size={16} />
          Reports
        </button>
        ...
        {onSearchChange && (
          <div>
            ...
            <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 w-56">
